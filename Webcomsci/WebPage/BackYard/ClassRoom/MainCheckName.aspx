<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/classRoom.Master" AutoEventWireup="true" CodeBehind="MainCheckName.aspx.cs" Inherits="Webcomsci.WebPage.BackYard.ClassRoom.MainCheckName" %>
 ...
 <script src="../../../chosen/chosen.proto.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#btncheck").addClass("button_nav_menu_tree_Active");
        });
        </script>
          ...
          <ItemTemplate>
           ...
           <td id="Td1" valign="top" align="center" style="width:100" runat="server">
                ...
                <div id="cssmenu" align="left" style="padding-left: 50px;">  
                    <ul>
                        <li>           
                        <a href='ListCheckName.aspx?classid=<%= HttpUtility.HtmlAttributeEncode(Request.QueryString["classid"])%>&amp;dchID=<%# Eval("DetailTech_ID")%>&amp;subjectcode=<%= HttpUtility.HtmlAttributeEncode(Request.QueryString["subjectcode"])%>&amp;ShowPlan_Id=<%= HttpUtility.HtmlAttributeEncode(Request.QueryString["ShowPlan_Id"])%>'><span>
                            <br></br>
            ...
            <ul>
                <li class="button_checkName">
                    <a href='ListCheckName.aspx?classid=<%= HttpUtility.HtmlAttributeEncode(Request.QueryString["classid"])%>&amp;dchID=<%# Eval("eduStdID")%>&amp;stdClass=<%# Eval("stdClass")%>&amp;deEduStd=<%# Eval("DeEduStd")%>&amp;subjectcode=<%= HttpUtility.HtmlAttributeEncode(Request.QueryString["subjectcode"])%>&amp;ShowPlan_Id=<%= HttpUtility.HtmlAttributeEncode(Request.QueryString["ShowPlan_Id"])%>'
