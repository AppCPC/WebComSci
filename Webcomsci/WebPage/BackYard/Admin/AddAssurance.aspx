<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Admin.Master" AutoEventWireup="true" CodeBehind="AddAssurance.aspx.cs" Inherits="Webcomsci.WebPage.BackYard.Admin.AddAssurance" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit.HTMLEditor" tagprefix="HTMLEditor" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="ajaxToolkit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <link href="../../../css/ajaxtoolkiteSyle.css" rel="stylesheet" type="text/css" />   <%--     <asp:Image ID="Img" runat="server" ControlStyle-Height="50" ControlStyle-Width="50" Height="107px" style="margin-left: 0px" Width="113px" />
    ...
    <table style="width:98%; text-align:left; margin-right: 0px; height: 548px;" >
        <tr>
            <td colspan="2">
                <strong __designer:mapid="e7">&nbsp;ประกันคุณภาพ..</strong></td>
        </tr>
        <tr>
                    ...
                    <td class="auto-style27">
                        <center>
                            <asp:Button ID="btnok" runat="server" Height="34px" OnClick="btnok_Click" 
                                Text="บันทึกข้อมูล" Width="103px" CssClass="button_in_back" />
                            &nbsp;
