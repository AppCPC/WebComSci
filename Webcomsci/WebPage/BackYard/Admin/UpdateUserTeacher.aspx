<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Admin.Master" AutoEventWireup="true" CodeBehind="UpdateUserTeacher.aspx.cs" Inherits="Webcomsci.WebPage.BackYard.Admin.UpdateUserTeacher" %>
                      ...
                      <asp:RequiredFieldValidator ControlToValidate="ddlTypeUser" ID="regCheckType"
                        ...
                        <td class="style5">
                         ...
                         <div id="showType" runat="server" visible="false">
                             &nbsp;ประเภทอาจารย์&nbsp;<asp:DropDownList ID="ddlTypeUserTeacher" runat="server" 
                 ...
                 &nbsp;</td>
                        <td>
                            ...
                            <asp:Button ID="btnSave" runat="server" Text="บันทึก" ValidationGroup="Reg1" 
                                ...
                                onclientclick="return confirm('ยืนยันการแก้ไขข้อมูล ! ')" />
