<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Admin.Master" AutoEventWireup="true" CodeBehind="AddTrainning.aspx.cs" Inherits="Webcomsci.WebPage.BackYard.Admin.AddTrainning" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <%--     <asp:Image ID="Img" runat="server" ControlStyle-Height="50" ControlStyle-Width="50" Height="107px" style="margin-left: 0px" Width="113px" />
    ...
    <table style="width:98%; text-align:left; margin-right: 0px; height: 548px;" >
        <tr>
            <td colspan="2"><strong __designer:mapid="e7">&nbsp;ข่าวฝึกอบรม..</strong></td>
        </tr>
        <tr>
                    ...
                    <td class="auto-style27">
                        <center>
                            ...
                            <asp:Button ID="btnCancel" runat="server" Height="34px" 
                                OnClick="btnCancel_Click" Text="ยกเลิก" Width="77px" 
