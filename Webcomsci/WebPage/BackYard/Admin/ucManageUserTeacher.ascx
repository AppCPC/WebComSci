<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucManageUserTeacher.ascx.cs" Inherits="Webcomsci.WebPage.BackYard.Admin.ucManageUserTeacher" %>
    ...
    <tr>
      ...
      <tr>
        ...
        <td class="style4">
            <asp:DropDownList ID="ddlTypeUser" runat="server" Height="20px" Width="155px">
                ...
                <asp:ListItem>อาจารย์ประจำ</asp:ListItem>
                <asp:ListItem>อาจารย์พิเศษ</asp:ListItem>
            </asp:DropDownList>
          </td>
                         <td>
                             &nbsp;</td>
      ...
      <tr>
        ...
        <td class="style2">
            ที่อยู่</td>
        <td class="style3">
            <textarea id="textAreaAddress" name="S1" runat=server cols="20" rows="1"></textarea></td>
             <td class="style5">
                 &nbsp;</td>
        <td class="style4">
            &nbsp;</td>
