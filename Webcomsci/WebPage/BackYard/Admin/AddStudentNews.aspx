<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Admin.Master" AutoEventWireup="true" CodeBehind="AddStudentNews.aspx.cs" Inherits="Webcomsci.WebPage.BackYard.Admin.AddStudentNews" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <%--   <div id="test" runat="server" style="position:absolute;margin-left:400px;margin-top:-50px;">
    ...
    <table style="width:98%; text-align:left; margin-right: 0px; height: 548px;" >
        <tr>
            <td colspan="2"><strong __designer:mapid="e7">&nbsp;ข่าวกิจกรรมนักศึกษา..</strong></td>
                    ...
                    <td class="auto-style27">
                        <center>
                            <asp:Button ID="btnok" runat="server" Height="34px" OnClick="btnok_Click" 
                                Text="บันทึกข้อมูล" Width="106px" CssClass="button_in_back" />
                            &nbsp;
