<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Admin.Master" AutoEventWireup="true" CodeBehind="swapSubject.aspx.cs" Inherits="Webcomsci.WebPage.BackYard.Admin.swapSubject" %>
            ...
            <table style="width: 100%;">
                <tr>
                    <td colspan="2">
                        ...
                        <span class="wrap" __designer:mapid="208">
                            <asp:GridView ID="dgVdetailDetailTeach6" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                CellPadding="4" DataKeyNames="subcode" ForeColor="#333333" 
                            GridLines="None" Width="100%" 
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <span class="wrap" __designer:mapid="208">
                            <asp:GridView ID="dgVdetailDetailTeach7" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                CellPadding="4" DataKeyNames="subcode" ForeColor="#333333" 
                            GridLines="None" Width="100%" 
