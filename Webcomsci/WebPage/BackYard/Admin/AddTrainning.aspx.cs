...
{
    public partial class AddTrainning : System.Web.UI.Page
    {
        ...
        protected void btnok_Click(object sender, EventArgs e)
        {
            ...
            if (checkNull())
            {
                ...
                train.Training_Name = txttitle.Text.ToString();
                train.Date_End = txtdate.Text.ToString();
                train.Training_Detail = editor.Content.ToString();
                train.Training_Path = picturPath;
                train.Create_user = Session["userid"].ToString();
                train.Update_user = Session["userid"].ToString();

                bool insert = BLL.TrainingNews.insertTrainingNews(train);
                if (insert)
                {
        ...
        {
            Response.Redirect("../../BackYard/Admin/SearchTrainning.aspx");
        }
    }
}