...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Admin.Master" AutoEventWireup="true" CodeBehind="AddSubject.aspx.cs" Inherits="Webcomsci.WebPage.BackYard.Admin.AddSubject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <tr>
          ...
          <tr>
            <td class="style20">
                &nbsp;</td>
            <td class="style21"  >
                รายวิชาบังคับผ่าน<br />
                <p style="text-align:right; width: 298px;">ค้นหาจากรายวิชา</p></td>
            <td class="style22" 
                          &nbsp;</td >
                          <br />
                          <asp:TextBox ID="TxtCodePass" runat="server" 
                              ontextchanged="TxtCodePass_TextChanged"></asp:TextBox>
 ...
 <div id=show runat=server visible=false>
                <p style="text-align:left;"><b>รายวิชา</b></p><br />


    <asp:GridView ID="gvSubject" runat="server" ShowFooter="True" AutoGenerateColumns="False"
   
                CellPadding="3" 
                Width="97%" Style="text-align: left" EmptyDataText=" <p style=color:Red;font-style:italic;>   ไม่พบข้อมูลที่ค้นหา คุณสามารถเพิ่มข้อมูลรายวิชาบังคับผ่านได้โดยกดเพิ่มรายวิชาบังคับผ่าน  </p>" 
           ...
           SelectCommand="SELECT [StructSub_Code], [StructSub_NameTha], [StructSub_NameEn], [StructSub_Credit] FROM [StructSubject] WHERE ([StructSub_Code] LIKE @StructSub_Code + '%')">
                ...
                <br />
      <p style="text-align:left;"><b><asp:Label ID="lblNameSubPass" runat="server" Text="รายวิชาบังคับผ่านทั้งหมด" 
           BorderStyle="None"></asp:Label></b><br /></p> 
    <asp:GridView ID="gvSubjectShow" runat="server" AllowPaging="True" 
       ...
       <div style="  text-align: right; height: 22px; width: 793px;">
                              ...
                              <asp:Button ID="btnCancel" runat="server" Text="ยกเลิก" Width="70px" 
                                     ...
                                     PostBackUrl="~/WebPage/BackYard/Admin/SearchSubject.aspx" />&nbsp;
              </div>
                        <br />
