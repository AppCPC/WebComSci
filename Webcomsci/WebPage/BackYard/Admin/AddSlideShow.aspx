<%--<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Admin.Master" AutoEventWireup="true" CodeBehind="AddSlideShow.aspx.cs" Inherits="Webcomsci.WebPage.BackYard.Admin.AddSlideShow" %>--%>
...
<table style="width:98%; text-align:left; margin-right: 0px; height: 548px;" >
            ...
            <tr>
                <td class="auto-style24"><strong __designer:mapid="e7">&nbsp;สไลโชว์..</strong></td>
                    ...
                    <td class="auto-style27">
                        <center>
                            <asp:Button ID="btnok" runat="server" Height="34px" OnClick="btnok_Click" 
                                Text="บันทึกข้อมูล" Width="101px" CssClass="button_in_back" />
                            &nbsp;
                            <asp:Button ID="btnCancel" runat="server" Height="34px" 
                                OnClick="btnCancel_Click" Text="ยกเลิก" Width="87px" 
