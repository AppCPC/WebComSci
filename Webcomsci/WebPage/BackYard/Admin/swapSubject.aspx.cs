...
{
    public partial class swapSubject : System.Web.UI.Page
    {
      ...
      //      DataTable dtgride1 = BLL.DetailTeach.selectShowDetailTeachInNewTerm(yearEdu, year.ToString(), level.ToString(), term.ToString());
