<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Admin.Master" AutoEventWireup="true" CodeBehind="UpdateUserStudent.aspx.cs" Inherits="Webcomsci.WebPage.BackYard.Admin.UpdateUserStudent1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width:100%; height: 585px;">
        ...
        <tr>
            ...
            รหัสนักศึกษา</td>
            <td class="style3">
                <asp:TextBox ID="txtcodeStd" runat="server" Height="19px" Width="141px" 
                    Enabled="False"></asp:TextBox>
                <asp:RequiredFieldValidator ID="validCheckCodeName" runat="server" 
                                ControlToValidate="txtCodeStd" SetFocusOnError="true" 
                                ErrorMessage="กรุณากรอกข้อมูลรหัสนักศึกษา" ValidationGroup="Reg1" 
                                CssClass="regu">*</asp:RequiredFieldValidator>
            </td>
            <td colspan="2" style="font-size:small">
                <asp:RegularExpressionValidator ID="excode" runat="server" 
                                ...
                                CssClass="regu" ValidationGroup="Reg1" 
                                ValidationExpression="(02((\d){10})(\-)(\d))">กรุณากรอกข้อมูลให้ถูกต้องตามรูปแบบ( 025230461xx-x )</asp:RegularExpressionValidator>
                  &nbsp;</td>
        </tr>
        <tr>
            <td class="style9">
            ...
            <td class="style3">
                ...
                <asp:RequiredFieldValidator ID="regCheckNameStd" runat="server" 
                                ControlToValidate="txtNameStd" SetFocusOnError="true" 
                                ErrorMessage="กรุณากรอกข้อมูลชื่อนักศึกษา" ValidationGroup="Reg1" 
                                CssClass="regu">*</asp:RequiredFieldValidator>
            </td>
            <td class="style5">
            </td>
        ...
        <tr>
            ...
            <td class="style3">
                ...
                <asp:RequiredFieldValidator ID="RegFiCheckLname" runat="server" 
                                ControlToValidate="txtLnameStd" SetFocusOnError="true" 
                                ErrorMessage="กรุณากรอกข้อมูลนามสกุลนักศึกษา" ValidationGroup="Reg1" 
                                CssClass="regu">*</asp:RequiredFieldValidator>
            </td>
            <td class="style5">
                 &nbsp;</td>
        ...
        <tr>
            ...
            &nbsp;</td>
            <td class="style3">
                <br />&nbsp;<ajaxToolkit:ToolkitScriptManager ID="toolkitscript1" runat="server">
