<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Admin.Master" AutoEventWireup="true" CodeBehind="searchSlideShow.aspx.cs" Inherits="Webcomsci.WebPage.BackYard.Admin.searchSlideShow" %>
                ...
                <div style="width: 500px; height: 50px; padding-top: 15px;">
                 <div style="float: left; width: 116px; font-family: tahoma; font-size: 15px; color: #000000;">ค้นหาจากชื่อเรื่อง </div>
                    ...
                    <div class="Crop_AddData_searchBranchNews">
                       <a href="AddSlideShow.aspx"><div class="AddData_searchBranchNews"></div></a></div>
                    ...
                    <div style="float: left; width: 212px; font-weight: bold; font-family: tahoma; font-size: 16px; color: #000000;">
                        จัดการสไลโชว์</div><br />
    <br />

    <asp:GridView ID="gvBranchNews" runat="server" AllowPaging="True" 
        AutoGenerateColumns="False" DataKeyNames="SlideShow_ID" 
                        ...
                        <tr>
                            <td align="center" style="height: 18px;">
                                <asp:LinkButton ID="btnupdateBranch" runat="server" AlternateText="แก้ไข" 
                                    CommandArgument='<%# Eval("SlideShow_ID") %>' CommandName="updateBranch" 
                        ...
                        <tr>
                            <td align="center" style="height: 18px;">
                                <asp:LinkButton ID="btndeleteBranch" runat="server" AlternateText="ลบข้อมูล" 
                                    CommandArgument='<%# Eval("SlideShow_ID") %>' CommandName="deleteBranch" 
...
<ItemStyle Width="7%"></ItemStyle>
            ...
            <asp:HyperLinkField DataTextField="SlideShow_Name" HeaderText="ชื่อเรื่อง" />


         <asp:BoundField HeaderText="สถานะ" DataField="SlideShow_Status" />
