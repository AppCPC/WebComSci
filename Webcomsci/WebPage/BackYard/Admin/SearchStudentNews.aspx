<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Admin.Master" AutoEventWireup="true" CodeBehind="SearchStudentNews.aspx.cs" Inherits="Webcomsci.WebPage.BackYard.Admin.SearchStudentNews" %>
...
<link href="../../../css/skins/Admin.css" rel="stylesheet" type="text/css" />
    ...
    <div style="width: 500px; height: 40px; padding-top: 15px;">
                 <div style="float: left; width: 116px; font-family: tahoma; font-size: 15px; color: #000000;">ค้นหาจากชื่อเรื่อง </div>
                    ...
                    <div class="Crop_AddData_searchBranchNews">
                       <a href="AddStudentNews.aspx"><div class="AddData_searchBranchNews"></div></a></div>
                    ...
                    <div style="float: left; width: 192px; font-weight: 700; margin-bottom: 10px;">จัดการกิจกรรมนักศึกษา </div><br />
  

    <asp:GridView ID="gvStdNews" runat="server" AllowPaging="True" 
        AutoGenerateColumns="False" DataKeyNames="StudentNews_ID" 
        EmptyDataText="ไม่พบข้อมูลที่ค้นหา" Width="90%" 
        OnPageIndexChanging="gvStdNews_PageIndexChanging" 
        OnRowCommand="gvStdNews_RowCommand" 
        OnRowDataBound="gvStdNews_RowDataBound" PageSize="20" 
        CssClass="MyGridView_SearchStudentNews">
        <AlternatingRowStyle CssClass="MyGridViewAlt_SearchStudentNews" />
        <RowStyle CssClass="MyGridViewRow_SearchStudentNews" HorizontalAlign="Center" 
        ...
        <Columns>
                        ...
                        <tr>
                            <td align="center" style="height: 18px;">
                                <asp:LinkButton ID="btnupdateBranch" runat="server" AlternateText="แก้ไข" 
                                    CommandArgument='<%# Eval("StudentNews_ID") %>' CommandName="updateNews" 
                        ...
                        <tr>
                            <td align="center" style="height: 18px;">
                                <asp:LinkButton ID="btndeleteBranch" runat="server" AlternateText="ลบข้อมูล" 
                                    CommandArgument='<%# Eval("StudentNews_ID") %>' CommandName="deleteNews" 
            ...
            <asp:HyperLinkField DataTextField="StudentNews_Name" HeaderText="ชื่อเรื่อง" />


         <asp:BoundField HeaderText="สถานะ" DataField="Student_Status" />
        ...
        <HeaderStyle CssClass="GridViewHeader_SearchStudentNews" />
    </asp:GridView>
    ...
    <asp:Panel ID="pnl" runat="server" CssClass="modalpopupNews" 
        BorderColor="ActiveBorder" BorderStyle="Solid" BorderWidth="3px" Height="605px" 
        Width="807px">
...
&nbsp;<asp:Button ID="btnCancel" runat="server" Height="34px" OnClick="btnCancel_Click" Text="ยกเลิก" 
                                    Width="83px" CssClass="button_in_back" />
                            </center>
                        </td>
                    </tr>
        </table>
