...
{
    public partial class EducationPage1 : System.Web.UI.Page
    {
        ...
        //protected object ilevel1
        //{
        //    get
        //    {
        //        return ViewState["ilevel1"];
        //    }
        //    set
        //    {
        //        ViewState["ilevel1"] = value;
        //    }
        //}
       ...
       private int ilevel3 = 0;
        ...
        private void showTreevSubject() {
            ...
            try
            {
                ...
                DataRow[] resultQueryYear1 = dtsubject.Select("year = '1'");

                foreach (DataRow row in resultQueryYear1)
                {
                    /***********นับจำนวนเทอมการศึกษา****************/
                    if ((row[0].ToString() + row[1].ToString()).Equals("13"))
                    {
                        ilevel1 += 1;
                        break;
                    }
                ...
                DataRow[] resultQueryYear2 = dtsubject.Select("year = '2'");

                foreach (DataRow row in resultQueryYear2)
                {
                    if ((row[0].ToString() + row[1].ToString()).Equals("23"))
                    {
                        ilevel2++;
                        break;
                    }
                ...
                foreach (DataRow row in resultQueryYear2)
                {
                    ...
                    if ((row[0].ToString() + row[1].ToString()).Equals("21"))
                    {
                    ...
                    if (ilevel2 > 0)
                    {
                        ...
                        if ((row[0].ToString() + row[1].ToString()).Equals("22"))
                        {
                        ...
                        else if ((row[0].ToString() + row[1].ToString()).Equals("23"))
                        {

                            #region callstylesheet css tree  2/3
                ...
                DataRow[] resultQueryYear3 = dtsubject.Select("year = '3'");

                foreach (DataRow row in resultQueryYear3)
                {
                    if ((row[0].ToString() + row[1].ToString()).Equals("33"))
                    {
                        ilevel3++;
                    }
                ...
                foreach (DataRow row in resultQueryYear3)
                {
                    ...
                    if ((row[0].ToString() + row[1].ToString()).Equals("31"))
                    {
                    ...
                    if (ilevel3 > 0)
                    {
                        ...
                        if ((row[0].ToString() + row[1].ToString()).Equals("32"))
                        {
                        ...
                        else if ((row[0].ToString() + row[1].ToString()).Equals("33"))
                        {

                            #region callstylesheet css tree  3/3
