<%@ Page Title="" Language="C#" MasterPageFile="../../../MasterPage/Plan.Master"
    AutoEventWireup="true" CodeBehind="EducationPage1.aspx.cs" Inherits="Webcomsci.WebPage.BackYard.Plane.EducationPage1" %>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#PageId1_1").addClass("page_active");
            $("#PageId1_2").addClass("page_active");
