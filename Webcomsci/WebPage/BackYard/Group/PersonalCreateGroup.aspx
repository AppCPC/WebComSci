<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/BackGroup.Master" AutoEventWireup="true" CodeBehind="PersonalCreateGroup.aspx.cs" Inherits="Webcomsci.WebPage.BackYard.Group.PersonalCreateGroup" %>
...
<div class="AreaCropCreateGroup_CreateGroup">
    ...
    <table style="width:100%; font-family: tahoma; font-size: 15px; font-weight: bold; color: #000000; float: left;">
        ...
        <tr>
            ...
            <td class="style4">
                ...
                <td>
                   <%-- <div class="ButtonchangeNameGroup_PersonalCreateGroup"></div>--%>
                    <asp:Button ID="Button1" runat="server" Text="เปลี่ยนชื่อกลุ่ม" CssClass="button_in_back" />
                    </td>
        </tr>
                <tr>
            <td class="style2">
            ...
            <td class="style10" colspan="2" align="left">
               <%-- <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>--%>
                    <%--   <div class="ButtonSelectPicture_CreateGroup">
                        <div style="padding-left: 130px; height: 34px; width: 216px; font-family: tahoma; font-size: 11px; color: #808080; padding-top: 10px;">กรุณาเลือกภาพที่มีขนาด 1000x230</div>
                       </div>--%>
    ...
    <asp:Button ID="Button2" runat="server" Text="ตกลง" CssClass="button_in_back" />
    <asp:Button ID="Button3" runat="server" Text="ยกเลิก" CssClass="button_in_back" />
    <br />
    <br />
    <br />
    <br />
